MAIN_REGEX = {
        ...
        "https?://(anidrive|driveroot|driveflix|indidrive|drivehub|appdrive|driveapp|driveace|gdflix|drivelinks|drivebit|drivesharer|drivepro)\.\S+": ["appdrive", "appdrive_bypass"],
        "https?://(.+)\.gdtot\.(.+)\/\S+\/\S+": ["gdtot", "gdtot_bypass"],
        "https?://(drivebuzz)\S+": ["drivebuzz", "drivebuzz_bypass"],
        "https?://(drivefire)\S+": ["drivefire", "drivefire_bypass"],
        "https?://(gadrive)\S+": ["gadrive", "gadrive_bypass"],
        "https?://(hubdrive)\S+": ["hubdrive", "hubdrive_bypass"],
        "https?://(jiodrive)\S+": ["jiodrive", "jiodrive_bypass"],
        "https?://(katdrive)\S+": ["katdrive", "katdrive_bypass"],
        "https?://(kolop)\S+": ["kolop", "kolop_bypass"],
