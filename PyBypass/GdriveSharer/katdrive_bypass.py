...
regex: https?://(katdrive)\S+

https://katdrive.net/file/1666896133

crypt_example: b0lDek5LSCt6ZjVRR2EwZnY4T1EvVndqeDRtbCtTWmMwcGNuKy8wYWpDaz0%3D

Note: 
If your 15 gb main drive get full then
It automatically get shifted to first TD in wich he have write access, so use katdrive_crypt of a account who have only one TD.
"""


def katdrive_bypass(url: str, katdrive_crypt: str) -> str:
