...
regex: https?://(jiodrive)\S+

https://www.jiodrive.xyz/file/18404801752

crypt_example: b0lDek5LSCt6ZjVRR2EwZnY4T1EvVndqeDRtbCtTWmMwcGNuKy8wYWpDaz0%3D

Note: 
If your 15 gb main drive get full then
It automatically get shifted to first TD in wich he have write access, so use jiodrive_crypt of a account who have only one TD.
"""


def jiodrive_bypass(url: str, jiodrive_crypt: str) -> str:
