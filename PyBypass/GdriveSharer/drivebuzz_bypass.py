...
regex: https?://(drivebuzz)\S+

https://drivebuzz.icu/file/1476542357

crypt_example: b0lDek5LSCt6ZjVRR2EwZnY4T1EvVndqeDRtbCtTWmMwcGNuKy8wYWpDaz0%3D

Note: 
If your 15 gb main drive get full then
It automatically get shifted to first TD in wich he have write access, so use drivebuzz_crypt of a account who have only one TD.
"""


def drivebuzz_bypass(url: str, drivebuzz_crypt: str) -> str:
